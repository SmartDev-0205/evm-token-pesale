...
import coinLogo from "../components/assets/img/luckyshiba.png";
...
export default function Presale(props) {
	...
	const buyHandle = async () => {
		console.log("current ehter amount",ETHamount);
		if (ETHamount !== 0)
		{
			setBuyLoading(true);	
			await buy(ETHamount); 
		...
		<ScrollingProvider>
			...
			<div className="footer_Container">
									...
									<Grid item lg={9} md={9} xs={12}>
										<Item>
											<div className="contactSet">
												<input type="number" onChange={onChangeETH} value={Number(ETHamount)} className="contactAddress" placeholder="Enter ETH" />
											</div>
										</Item>
									</Grid>
								</Grid>
				...
				<div className="footer space_top center">
					<Container>
						<div className="space-third"></div>
						<span className="x_font_y_3"><b> CONTACT <br />THE SHIBA'S TEAM</b></span>
						<div className="space-single"></div>
						<div className="space-single"></div>
						<Grid container>
							<Grid item lg={6} md={6} sm={12}>
								<span className="x_font_f_5">STAY TUNED FOR SHIBA'S</span>
								<br />
						...
						<div className="space_top">
							<img src={logo} alt="NoImg" className="f_logo_img" /><label className="x_font_w_2">SHIBA's</label>
						</div>
					</Container>
				</div>
				<div className="space-double"></div>
				<Item><label style={{ color: "white" }}>Copyright &copy; 2022 SHIBA Company S.L. All rights reserved.</label></Item>
				<div className="space-single"></div>
				<div className="space-single"></div>
				<div className="space-single"></div>
				<div className="space-single"></div>
